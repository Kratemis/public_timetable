...
<div class="user-form">
    ...
    <?= $form->field($model, 'send_email')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'timesSix')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'timesReduced')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'timesFridays')->textInput(['maxlength' => true]) ?>
